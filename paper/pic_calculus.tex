...
But there is \emph{no clean functional form}: it is \textbf{architecture-dependent}. Within Pythia,
...
So $\tau^\star$ is capacity-associated rather than entropy-bound, with \emph{no universal law} across
architectures; its functional form is \open{}. We keep it as the sharpest example of the discipline the
