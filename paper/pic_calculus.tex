...
\section{Frame versus decode}\label{sec:sep}

Every PIC quantity is either \emph{frame-side} (a function of $\{U_v\}$ alone---intrinsic, label-free)
or \emph{decode-side} (a function of the aggregate $L$ and a target, evaluated in the chosen semiring).
